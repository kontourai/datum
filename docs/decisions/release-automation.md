...
This subject has provenance in frozen ADR history ([0006-slice-2-additions.md](../adr/0006-slice-2-additions.md)) but no living
...
When a living decision is ratified for release automation,
