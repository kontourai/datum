...
evidence:
  - kind: adr
    ref: docs/adr/0001-configuration-resolution.md
---
# Configuration resolution

This subject has provenance in frozen ADR history ([0001-configuration-resolution.md](../adr/0001-configuration-resolution.md)) but no living
...
When a living decision is ratified for configuration resolution,
