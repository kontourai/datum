...
// updated to this repo's vendored copy path) for datum's ADR freeze-and-index
// adoption, following the kontourai/traverse pilot (PR #17) and
...
function renderIndex(topics) {
  ...
  lines.push("Topic-keyed living decision records per `context/contracts/decision-registry-contract.md` (in kontourai/flow-agents).");
